  ...
  methods: {
    upload(e) {
      ...
      files.forEach((file) => {
        ...
        // Creating another reference for the new song upload
        // Eg: music-sharing-app-15966.appspot.com/songs + /example.mp3
        ...
        task.on(
          ...
          async () => {
            ...
            // Converting reference into snapshot
            const songSnapshot = await songRef.get();

            this.addUploadedSong(songSnapshot);

<template>
  <!-- Registration Form -->
  <div class="text-white text-center fond-bold p-5 mb-4" v-if="reg_show_alert" :class="reg_alert_variant">
    {{ reg_alert_msg }}
  </div>
  <vee-form :validation-schema="schema" @submit="register" :initial-values="userData">
    ...
    <!-- User type -->
    <div class="mb-3">
      <label class="inline-block mb-2">Are you an artist or a listener?</label>
      <vee-field
        as="select"
        name="userType"
        class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
      ...
      >
        ...
        <option value="listener">I'm listening to music</option>
      </vee-field>
...
export default {
  ...
  data() {
    return {
      ...
      reg_alert_msg: "We are logging you in, please wait..",
    };
  },
